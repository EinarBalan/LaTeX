...
\kw{Big Idea} We can encode circuits as binary strings. Two corollaries to this idea: 1. Some functions need exponential size circuits and 2. Universal circuits exist (i.e. general computers)
